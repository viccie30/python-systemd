...
def process(includefile, docfile, stubfile, *headers):
    ...
    with open(stubfile, 'wt') as out:
        ...
        for line in old:
            ...
            if 'autogenerated' in line:
                break
        for name, _ in defs:
            print(f'{name}: Final[uuid.UUID]', file=out)
...
if __name__ == '__main__':
    ...
    stubfile = sys.argv[3]
    headers = sys.argv[4:]
    process(includefile, docfile, stubfile, *headers)
